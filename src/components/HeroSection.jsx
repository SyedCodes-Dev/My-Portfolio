  ...
  return (
    <div className="flex items-center justify-center gap-3 sm:gap-5 font-mono text-xs uppercase tracking-[0.15em] text-black/50">
      <div className="flex items-center gap-2">
        <span className="font-bold text-black/70">Based in Pakistan</span>
      </div>
      ...
      >
        ...
        >
          ...
          <p className="font-sans text-base text-black/60 max-w-xl leading-7 mt-2 px-4">
            Frontend Developer & React Developer focused on modern, responsive and interactive web experiences.
          </p>
        </Gsap.div>
        ...
        >
          ...
          <a
            href="https://wa.me/923371800185" target="_blank" rel="noreferrer"
            download
          ...
          >
            Let’s Talk <ArrowUpRight size={16} className="group-hover:translate-y-0.5 transition-transform" />
          </a>
        </Gsap.div>
