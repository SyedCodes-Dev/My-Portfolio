              ...
              <div className="absolute inset-0 overflow-hidden">
                <picture>
                  ...
                  <img
                    ...
                    decoding="async"
                    className={`h-full w-full object-cover opacity-70 grayscale-[30%] ${project.placeholder ? "opacity-10" : ""}`}
              ...
              <div className="absolute inset-0 overflow-hidden bg-neutral-950">
                <picture>
                  ...
                  <img
                    ...
                    loading={index === 0 ? "eager" : "lazy"}
                    decoding="async"
                    className={`h-full w-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-80 group-hover:opacity-100 grayscale-[50%] group-hover:grayscale-0 will-change-transform ${project.placeholder ? "opacity-5" : ""}`}
                    style={{ imageRendering: "auto" }}
                  />
                </picture>
              </div>
