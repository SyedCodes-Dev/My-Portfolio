...
const CAPABILITIES = [
  { title: 'Frontend Development', desc: 'Responsive, polished interfaces built with semantic HTML, CSS and modern JavaScript.', icon: MonitorSmartphone },
  { title: 'React Development', desc: 'Component-based React applications built with reusable UI patterns and modern tooling.', icon: Cpu },
  { title: 'UI/UX Design', desc: 'Clean visual hierarchy, responsive layouts and user-focused interface decisions.', icon: Eye },
  { title: 'Interactive Motion', desc: 'Thoughtful hover effects, transitions, parallax and micro-interactions that support the experience.', icon: Infinity },
  { title: 'JavaScript', desc: 'Interactive functionality, DOM behavior, state-driven UI and frontend logic.', icon: Network },
  { title: 'Responsive Design', desc: 'Layouts that adapt smoothly across desktop, tablet and mobile screen sizes.', icon: MonitorSmartphone },
  { title: 'Git & GitHub', desc: 'Version control, project repositories and deployment-ready frontend workflows.', icon: MessageSquare },
];
